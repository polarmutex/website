...
export const REPO_URL = 'https://github.com/polarmutex/website';

export const POST_CATEGORIES = ['Post', 'Talks']; // Other categories you can consider adding: Talks, Tutorials, Snippets, Podcasts, Notes...
